...
setupBot(bot1, "BelDex Support");
console.log("BelDex Support started");

setupBot(bot2, "Secondfi Support");
console.log("Secondfi Support started");

setupBot(bot3, "Moonbeam Support");
console.log("Moonbeam Support started");

setupBot(bot4, "Blockdage Support");
console.log("Blockdage Support started");

setupBot(bot5, "Best wallet Support");
console.log("Best wallet started");

setupBot(bot6, "Ticket Support");
console.log("Ticket Support started");

setupBot(bot7, "Little pepe Support");
console.log("Little pepe Support started");

setupBot(bot8, "Vanar Support");
console.log("Vanar Support started");

setupBot(bot9, "Bitmart Exchange Support");
console.log("Bitmart Exchange Support started");
